...
class Spike(RoomObject):
    def __init__(self, x, y):
        super().__init__(x, y, TILE_SIZE, TILE_SIZE, pygame.transform.scale(pygame.image.load(RoomObjects.SPIKE.value).convert_alpha(), (TILE_SIZE, TILE_SIZE)), is_obstacle=True)
